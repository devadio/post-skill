...
const SUPPORTED_PLATFORMS = [
  ...
  { handle: "li_page",     name: "LinkedIn Page",     help: "Text, images, videos, documents/PDF." },
  { handle: "li_profile",  name: "LinkedIn Profile",  help: "Text, images, videos." },
  { handle: "pinterest",   name: "Pinterest",         help: "Images, Multi-Images (Req Board ID)." },
  { handle: "tg_channel",  name: "Telegram Channel",  help: "Images, Videos, Documents." },
  { handle: "tg_group",    name: "Telegram Group",    help: "Text, image, video, PDF. Extra Field can set topic ID." },
